    ...
    >
      <Border>
        ...
        >
          ...
          <Typography variant="body1" color="primary.main">I'm based in Tandil, Argentina, passionate about using technology to create software that combines functionality and UX/UI to improve everyday life and transform the way people interact with the virtual world.
